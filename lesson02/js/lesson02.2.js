...
// let arrStr = [ 'a', 'b', 'c'];
// let word = '';
// for (let arrStrKey in arrStr) {
//     word = word + arrStr[arrStrKey];
// }console.log(word)
// // напевно опечатка в описі завдання, бо аналогічне попередньому , тому зробив циклом for in, напевно що не дуже
// // коректно, бо цикл фор ін застосовується  до об'єктів, щоб можна було гортати ключі обєктів